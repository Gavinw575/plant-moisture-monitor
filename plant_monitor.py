...
Touch-friendly 3-column grid with manual threshold entry
"""
...
class PlantMoistureApp:
    ...
    def setup_gui(self):
        ...
        tk.Label(title_frame, text="Plant Moisture Monitor", font=('Arial', 18, 'bold'), fg='white', bg='#2E8B57').pack()
    ...
    def setup_plant_tile(self, parent, plant_id):
        ...
        plant_widgets['status_label'] = tk.Label(parent, text="CHECKING...", font=('Arial', 14, 'bold'), bg='white', fg='orange')
        ...
        plant_widgets['voltage_label'] = tk.Label(parent, text="Voltage: --", font=('Arial', 12), bg='white')
        plant_widgets['voltage_label'].pack()

        tk.Button(parent, text="Set Thresholds", command=lambda: self.manual_thresholds(plant_id),
                 bg='#4CAF50', fg='white', font=('Arial', 12, 'bold'), width=12, height=2).pack(pady=5)
